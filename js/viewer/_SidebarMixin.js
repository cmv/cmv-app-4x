define([
    ...
    return declare(null, {
        ...
        postConfig: function () {
            ...
            if (this.config.layout.sidebar) {
                ...
                require([
                    ...
                    Sidebar = sidebar;
                    this.mapViewDeferred.then(lang.hitch(this, '_createSidebar'));
                    deferred.resolve();
                }));
                return deferred;
            }
        ...
        _createSidebar: function () {
            //var mapViewContainer = dom.byId(this.mapView.id);
            var mapViewContainer = dom.byId(this.mapView.container.id);
            //create controls div
            var mapViewControlsNode = put(this.mapView.root, 'div.sidebar-map');
            //create sidebar
            this.sidebar = new Sidebar({
                view: this.mapView,
                mapViewContainer: mapViewContainer,
                collapseSyncNode: mapViewControlsNode
            }, put(this.mapView.root, 'div'));
