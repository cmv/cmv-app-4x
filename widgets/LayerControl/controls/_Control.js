    ...
    var _Control = declare([], {
        ...
        _initialize: function () {
            ...
            if (layer.minScale !== 0 || layer.maxScale !== 0) {
                ...
                this._scaleRangeHandler = this.controller.view.on('zoom', lang.hitch(this, '_checkboxScaleRange'));
            }
            ...
            this._handlers.push(
                ...
                layer.watch('visible', () => { this._visibilityChange() }),
                this.controller.view.watch('updating', (updating) => {
                    updating === false ? this._updateEnd() : this._updateStart()
                }),
                this.controller.view.watch('scale', () => {
                    this._scaleRangeChange();
                })
        ...
        _checkboxScaleRange: function () {
            var node = this.checkNode,
                ...
                scale = this.controller.view.scale,
                min = layer.minScale,
                max = layer.maxScale;
        ...
        _updateStart: function () {
            if (this.layer.refreshInterval > 0) {
        ...
        _visibilityChange: function (r) {
            ...
            if ((this.layer.visible && domAttr.get(this.checkNode, 'data-checked') === 'unchecked') || (!this.layer.visible && domAttr.get(this.checkNode, 'data-checked') === 'checked')) {
