    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _QueryBuilderMixin], {
        ...
        */
	    ...
	    this.drawToolbar = new SketchViewModel(
            ...
            //this.drawToolbar.on('draw-end', lang.hitch(this, 'endDrawing'));
            this.drawToolbar.on('create', lang.hitch(this, 'endDrawing'));
	    //this.setUpGraphicClickHandler(this.view, this.drawToolbar);

/*
	    this.drawToolbar.on("create", function(event) {
...
*/
            ...
            if (this.view.infoWindow) {
                on(this.view.infoWindow, 'show', lang.hitch(this, 'enableIdentifyButton'));
                on(this.view.infoWindow, 'hide', lang.hitch(this, 'disableIdentifyButton'));
            }
            //this.own(on(this.drawToolbar, 'draw-end', lang.hitch(this, 'endDrawing')));

            if (this.view.infoWindow && this.view.infoWindow.count) {
                this.enableIdentifyButton();
            }
        ...
        *******************************/
        ...
        buildQueryOptions: function (layer, search, geometry, advancedQuery) {
            ...
            queryOptions.queryParameters = lang.mixin(queryParameters, {
                ...
                //outSpatialReference: search.outSpatialReference || this.view.spatialReference,
        ...
        *******************************/
        ...
        getLayerURL: function (qp) {
            ...
            if (!url && qp.layerID) {
                var layer = this.view.getLayer(qp.layerID);
                if (layer) {
        ...
        *******************************/
	    ...
	    this.disconnectMapViewClick();
            ...
            if (this.prepareForDrawing(btn)) {
                ...
                this.drawToolbar.create('rectangle',
                {
                    mode: 'click'
                });
            }
        ...
        endDrawing: function (evt) {
            if(evt.state === 'complete')
            {
                 ...
                 var clickMode = this.mapViewClickMode,
                     geometry = null;
     
                 if (clickMode === 'search' && evt && evt.graphic && evt.graphic.geometry) {
                 ...
                 if (geometry) {
                     ...
                     this.addDrawingGraphic(geometry);
                     this.addBufferGraphic();
        ...
        addGraphicsLayer: function () {
            ...
            this.view.map.add(this.drawingGraphicsLayer);
        ...
        addDrawingGraphic: function (geometry) {
            var symbol = null,
                graphic = null;
        ...
        *******************************/
        ...
        hideInfoWindow: function () {
            if (this.view && this.view.infoWindow) {
                this.view.infoWindow.hide();
            }
        },

        disconnectMapViewClick: function () {
            topic.publish('mapViewClickMode/setCurrent', 'search');
        },
        ...
        onLayoutChange: function (open) {
            if (!open && this.mapViewClickMode === 'search') {
                this.connectMapViewClick();
                //this.drawToolbar.deactivate();
                this.drawToolbar.cancel();
                this.inherited(arguments);
