define([
    ...
    var LayerControl = declare([WidgetBase, Container], {
                        ...
                        if (layerDetails && layerDetails.length > 1) {
                            ...
                            var layerInfo = {
                                ...
                                layer: {
                                    id: key.replace(/\s/g, ''),
                                    loaded: true,
                                    getView: lang.hitch(this, function () {
                                        return this.view;
                                    }),
                                    minScale: 0,
                                    maxScale: 0,
        ...
        _addControl: function (layerInfo, Control) {
            var layer = (typeof layerInfo.layer === 'string') ? this.view.map.findLayerById(layerInfo.layer.id) : layerInfo.layer;
            ...
            var layerControl = new Control({
                ...
                layerTitle: layerInfo.title ? layerInfo.title : layer.title,
