...
define({
    root: {
        ...
        'selectType': 'Selectionnez un format d exportation',
        'selectProjection': 'Projection de sortie (WKID)',
        'projection': 'Projection de sortie WKT',

        'download': 'Cliquez ici pour t&eacute;l&eacute;charger',
        ...
        'errorExcel': 'Impossible de cr&eacute;er une feuille de calcul Excel',
        'errorCSV': 'Impossible de cr&eacute;er un fichier CSV',
        'errorGeoJSON': 'Impossible de cr&eacute;er le fichier GeoJSON',
        'errorKML': 'Could not create KML File',
        'errorShapeFile': 'Impossible de cr&eacute;er le fichier KML',
        'errorTopoJSON': 'Impossible de cr&eacute;er le fichier TopoJSON',
        'errorWKT': 'Impossible de cr&eacute;er le fichier WKT',
        'errorSpatialParser': 'Impossible de trouver l analyseur Terraformer'
